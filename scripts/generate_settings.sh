...
rosrun irsl_choreonoid_ros generate_roslaunch.py --bodyfile $BODYFILE --use_wheel False --controllers "${CONTROLLERS_STR}" --demo_base_dir `pwd` --urdffile $URDFFILE --worldsettings $WORLDSETTINGFILE > run_sim_robot.launch
